        ...
        messages=[
            {
                "role": "system",
                "content": f'''
                당신은 주어진 텍스트의 핵심 내용을 정확하고 간결하게 대화 형식으로 요약해줄거야.
                화자는 두 명이 등장해. 첫 번째 화자는 논문에 대해 궁금해하는 것으로 논문의 주제, 논문의 저자, 논문의 연구방법, 논문의 결과를 대화체로 질문해.
                두 번째 화자는 그에 대해 답을 하는 거야.
                '''
            },
            {
                "role": "user",
                "content": f'''
논문의 주제, 논문의 저자, 논문의 연구방법, 논문의 결과를 요약을 할거야.
--- 원본 텍스트 ---
{txt}
'''
            },
